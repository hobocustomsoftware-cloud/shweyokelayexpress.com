...
@section('title', 'ကားအချက်အလက်များပြုပြင်မည် | ရွှေရုပ်လေး ကားလိုင်း')
@section('content')
<div class="app-content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
                <h3 class="mb-0">ကားအချက်အလက်များပြုပြင်မည်</h3>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                    <li class="breadcrumb-item"><a href="{{ route('admin.cars.index') }}">ကားအချက်အလက်များ</a></li>
                    <li class="breadcrumb-item active">ကားအချက်အလက်များပြုပြင်မည်</li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">ကားအချက်အလက်များပြုပြင်မည်</h3>
                </div>
                <div class="card-body">
                    @livewire('car-registration-form', ['form_type' => 'edit', 'id' => $car->id])
                </div>
            </div>
        </div>
    </div>
