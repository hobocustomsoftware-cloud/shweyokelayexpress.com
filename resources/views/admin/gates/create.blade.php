...
<div class="app-content-header">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-6">
                <h3 class="mb-0">ဂိတ်ထည့်မည်</h3>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">ပင်မစာမျက်နှာ</a></li>
                    <li class="breadcrumb-item active" aria-current="page">ဂိတ်ထည့်မည်</li>
                </ol>
            </div>
        </div>
        <!--end::Row-->
        ...
        <div class="row">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">ဂိတ်ထည့်မည်</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.gates.store') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    <label class="form-label" for="name_my">ဂိတ်အမည်(MM) <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="name_my" name="name_my">
                                    @error('name_my')
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-select form-select-sm select2" id="is_main" name="is_main">
                                        <option value="1">ပင်မဂိတ်</option>
                                        <option value="0">ဂိတ်ခွဲ</option>
                                    </select>
                                    @error('is_main')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-select form-select-sm select2" id="is_transit" name="is_transit">
                                        <option value="1">ဟုတ်တယ်</option>
                                        <option value="0">မဟုတ်ပါ</option>
                                    </select>
                                    @error('is_transit')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
                        ...
                        <a href="{{ route('admin.gates.index') }}" class="btn btn-sm btn-secondary">နောက်သို့</a>
